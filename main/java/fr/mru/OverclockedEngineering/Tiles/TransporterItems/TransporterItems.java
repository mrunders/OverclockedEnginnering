...
public class TransporterItems extends ABlockContainerManager {

	public TransporterItems() {
		super("transporter_items");
	}

	@Override
	public TileEntity createNewTileEntity(World world, int metadata)  {
	    return new TileTransporterItems();
	}
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
	    ...
	    if (tileentity instanceof TileTransporterItems) {
	        InventoryHelper.dropInventoryItems(worldIn, pos,
	                (TileTransporterItems) tileentity);
	    }
