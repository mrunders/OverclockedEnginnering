...
public class RecipeCategorieAlloyFocus extends BlankRecipeCategory<RecipeWrapperAlloyFocus>{
	
	public static final String ID = "overclockedengineering.alloyfocus";
	public static final String TITLE = I18n.format("Alloy Focus");
	
	private IDrawable background = null;
	
	public RecipeCategorieAlloyFocus(IGuiHelper helper) {
	...
	@Override
	public void setRecipe(IRecipeLayout arg0, RecipeWrapperAlloyFocus arg1, IIngredients arg2) {
