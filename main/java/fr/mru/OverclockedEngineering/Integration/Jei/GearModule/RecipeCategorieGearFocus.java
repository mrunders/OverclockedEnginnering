...
public class RecipeCategorieGearFocus extends BlankRecipeCategory<RecipeWrapperGearFocus>{
	
	public static final String ID = "overclockedengineering.gearfocus";
	public static final String TITLE = I18n.format("Gear Focus");
	
	private IDrawable background = null;
	
	public RecipeCategorieGearFocus(IGuiHelper helper) {
	...
	@Override
	public void setRecipe(IRecipeLayout arg0, RecipeWrapperGearFocus arg1, IIngredients arg2) {
