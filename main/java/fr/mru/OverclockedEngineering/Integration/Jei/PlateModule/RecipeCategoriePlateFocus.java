...
public class RecipeCategoriePlateFocus extends BlankRecipeCategory<RecipeWrapperPlateFocus>{
	
	public static final String ID = "overclockedengineering.platefocus";
	public static final String TITLE = I18n.format("Plate Focus");
	
	private IDrawable background = null;
	
	public RecipeCategoriePlateFocus(IGuiHelper helper) {
	...
	@Override
	public void setRecipe(IRecipeLayout arg0, RecipeWrapperPlateFocus arg1, IIngredients arg2) {
