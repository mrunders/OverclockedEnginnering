...
public class RecipeCategorieDecompresionFocus extends BlankRecipeCategory<RecipeWrapperDecompresionFocus>{
	
	public static final String ID = "overclockedengineering.decompresionfocus";
	public static final String TITLE = I18n.format("Decompresion Focus");
	
	private IDrawable background = null;
	
	public RecipeCategorieDecompresionFocus(IGuiHelper helper) {
	...
	@Override
	public void setRecipe(IRecipeLayout arg0, RecipeWrapperDecompresionFocus arg1, IIngredients arg2) {
