...
public class RecipeCategorieGrinderFocus extends BlankRecipeCategory<RecipeWrapperGrinderFocus>{
	
	public static final String ID = "overclockedengineering.grinderfocus";
	public static final String TITLE = I18n.format("Grinder Focus");
	
	private IDrawable background = null;
	
	public RecipeCategorieGrinderFocus(IGuiHelper helper) {
	...
	@Override
	public void setRecipe(IRecipeLayout arg0, RecipeWrapperGrinderFocus arg1, IIngredients arg2) {
